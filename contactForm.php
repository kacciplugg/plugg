<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mail->Subject = 'Contact Email from Plugg Resources';
        $mail->Body    = "<div style='padding-top:10px;padding-bottom:10px;border-radius:5px;'>
            ...
            Hello, <br><br> My name is $fName.<br><br> $message. <br><br> You can reach me via email at $email, and call or chat with me at $phone. <br><br> Thanks.
            </div>
            </div>";
        ...
        // Code for redirection
        echo "<script>window.location.href='contact-us.php'</script>", $mail->ErrorInfo;
    }
  }
